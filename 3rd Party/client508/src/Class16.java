...
public class Class16
{
    ...
    public static float[] aFloatArray396
    ...
    public void method949(float[] arg0, int arg1) {
	int i = anIntArray391.length;
	int i_0_ = anIntArray395[anInt386 - 1];
	aBooleanArray393[0] = aBooleanArray393[1] = true;
	for (int i_1_ = 2; i_1_ < i; i_1_++) {
	    int i_2_ = method954(anIntArray390, i_1_);
	    int i_3_ = method951(anIntArray390, i_1_);
	    int i_4_ = method955(anIntArray390[i_2_], anIntArray397[i_2_],
				 anIntArray390[i_3_], anIntArray397[i_3_],
				 anIntArray390[i_1_]);
	    int i_5_ = anIntArray397[i_1_];
	    int i_6_ = i_0_ - i_4_;
	    int i_7_ = i_4_;
	    int i_8_ = (i_6_ < i_7_ ? i_6_ : i_7_) << 1;
	    if (i_5_ != 0) {
		aBooleanArray393[i_2_] = aBooleanArray393[i_3_] = true;
		aBooleanArray393[i_1_] = true;
		if (i_5_ >= i_8_)
		    anIntArray397[i_1_] = (i_6_ > i_7_ ? i_5_ - i_7_ + i_4_
					   : i_4_ - i_5_ + i_6_ - 1);
		else
		    anIntArray397[i_1_]
			= ((i_5_ & 0x1) != 0 ? i_4_ - (i_5_ + 1) / 2
			   : i_4_ + i_5_ / 2);
	    } else {
		aBooleanArray393[i_1_] = false;
		anIntArray397[i_1_] = i_4_;
	    }
	}
	method950(0, i - 1);
	int i_9_ = 0;
	int i_10_ = anIntArray397[0] * anInt386;
	for (int i_11_ = 1; i_11_ < i; i_11_++) {
	    if (aBooleanArray393[i_11_]) {
		int i_12_ = anIntArray390[i_11_];
		int i_13_ = anIntArray397[i_11_] * anInt386;
		method953(i_9_, i_10_, i_12_, i_13_, arg0, arg1);
		if (i_12_ >= arg1)
		    return;
		i_9_ = i_12_;
		i_10_ = i_13_;
	...
	float f = aFloatArray396[i_10_];
	for (int i_14_ = i_9_; i_14_ < arg1; i_14_++)
	    arg0[i_14_] *= f;
    }
    
    public void method950(int arg0, int arg1) {
	if (arg0 < arg1) {
	    int i = arg0;
	    int i_15_ = anIntArray390[i];
	    int i_16_ = anIntArray397[i];
	    boolean bool = aBooleanArray393[i];
	    for (int i_17_ = arg0 + 1; i_17_ <= arg1; i_17_++) {
		int i_18_ = anIntArray390[i_17_];
		if (i_18_ < i_15_) {
		    anIntArray390[i] = i_18_;
		    anIntArray397[i] = anIntArray397[i_17_];
		    aBooleanArray393[i] = aBooleanArray393[i_17_];
		    i++;
		    anIntArray390[i_17_] = anIntArray390[i];
		    anIntArray397[i_17_] = anIntArray397[i];
		    aBooleanArray393[i_17_] = aBooleanArray393[i];
		}
	    }
	    anIntArray390[i] = i_15_;
	    anIntArray397[i] = i_16_;
	    aBooleanArray393[i] = bool;
	    method950(arg0, i - 1);
	    method950(i + 1, arg1);
	}
    }
    
    public static int method951(int[] arg0, int arg1) {
	int i = arg0[arg1];
	int i_19_ = -1;
	int i_20_ = 2147483647;
	for (int i_21_ = 0; i_21_ < arg1; i_21_++) {
	    int i_22_ = arg0[i_21_];
	    if (i_22_ > i && i_22_ < i_20_) {
		i_19_ = i_21_;
		i_20_ = i_22_;
	    }
	}
	...
	int i_23_ = Class14_Sub24.method906(5);
	int i_24_ = 0;
	anIntArray388 = new int[i_23_];
	for (int i_25_ = 0; i_25_ < i_23_; i_25_++) {
	    int i_26_ = Class14_Sub24.method906(4);
	    anIntArray388[i_25_] = i_26_;
	    if (i_26_ >= i_24_)
		i_24_ = i_26_ + 1;
	}
	anIntArray389 = new int[i_24_];
	anIntArray392 = new int[i_24_];
	anIntArray394 = new int[i_24_];
	anIntArrayArray387 = new int[i_24_][];
	for (int i_27_ = 0; i_27_ < i_24_; i_27_++) {
	    anIntArray389[i_27_] = Class14_Sub24.method906(3) + 1;
	    int i_28_ = anIntArray392[i_27_] = Class14_Sub24.method906(2);
	    if (i_28_ != 0)
		anIntArray394[i_27_] = Class14_Sub24.method906(8);
	    i_28_ = 1 << i_28_;
	    int[] is = new int[i_28_];
	    anIntArrayArray387[i_27_] = is;
	    for (int i_29_ = 0; i_29_ < i_28_; i_29_++)
		is[i_29_] = Class14_Sub24.method906(8) - 1;
	}
	anInt386 = Class14_Sub24.method906(2) + 1;
	int i_30_ = Class14_Sub24.method906(4);
	int i_31_ = 2;
	for (int i_32_ = 0; i_32_ < i_23_; i_32_++)
	    i_31_ += anIntArray389[anIntArray388[i_32_]];
	anIntArray391 = new int[i_31_];
	anIntArray391[0] = 0;
	anIntArray391[1] = 1 << i_30_;
	i_31_ = 2;
	for (int i_33_ = 0; i_33_ < i_23_; i_33_++) {
	    int i_34_ = anIntArray388[i_33_];
	    for (int i_35_ = 0; i_35_ < anIntArray389[i_34_]; i_35_++)
		anIntArray391[i_31_++] = Class14_Sub24.method906(i_30_);
	}
	if (anIntArray390 == null || anIntArray390.length < i_31_) {
	    anIntArray390 = new int[i_31_];
	    anIntArray397 = new int[i_31_];
	    aBooleanArray393 = new boolean[i_31_];
	}
    }
	...
	for (int i_36_ = 0; i_36_ < i; i_36_++)
	    anIntArray390[i_36_] = anIntArray391[i_36_];
	int i_37_ = anIntArray395[anInt386 - 1];
	int i_38_ = Class48.method1192(i_37_ - 1, 25039);
	anIntArray397[0] = Class14_Sub24.method906(i_38_);
	anIntArray397[1] = Class14_Sub24.method906(i_38_);
	int i_39_ = 2;
	for (int i_40_ = 0; i_40_ < anIntArray388.length; i_40_++) {
	    int i_41_ = anIntArray388[i_40_];
	    int i_42_ = anIntArray389[i_41_];
	    int i_43_ = anIntArray392[i_41_];
	    int i_44_ = (1 << i_43_) - 1;
	    int i_45_ = 0;
	    if (i_43_ > 0)
		i_45_ = Class14_Sub24.aClass78Array3159
			    [anIntArray394[i_41_]].method1371();
	    for (int i_46_ = 0; i_46_ < i_42_; i_46_++) {
		int i_47_ = anIntArrayArray387[i_41_][i_45_ & i_44_];
		i_45_ >>>= i_43_;
		anIntArray397[i_39_++]
		    = (i_47_ >= 0
		       ? Class14_Sub24.aClass78Array3159[i_47_].method1371()
		       : 0);
	    }
	}
	return true;
    ...
    public void method953(int arg0, int arg1, int arg2, int arg3, float[] arg4,
			  int arg5) {
	int i = arg3 - arg1;
	int i_48_ = arg2 - arg0;
	int i_49_ = i < 0 ? -i : i;
	...
	int i_51_ = arg1;
	int i_52_ = 0;
	int i_53_ = i < 0 ? i_50_ - 1 : i_50_ + 1;
	i_49_ = i_49_ - (i_50_ < 0 ? -i_50_ : i_50_) * i_48_;
	arg4[arg0] *= aFloatArray396[i_51_];
	if (arg2 > arg5)
	    arg2 = arg5;
	for (int i_54_ = arg0 + 1; i_54_ < arg2; i_54_++) {
	    i_52_ += i_49_;
	    if (i_52_ >= i_48_) {
		i_52_ -= i_48_;
		i_51_ += i_53_;
		...
		i_51_ += i_50_;
	    arg4[i_54_] *= aFloatArray396[i_51_];
	}
    }
    
    public static int method954(int[] arg0, int arg1) {
	int i = arg0[arg1];
	int i_55_ = -1;
	int i_56_ = -2147483648;
	for (int i_57_ = 0; i_57_ < arg1; i_57_++) {
	    int i_58_ = arg0[i_57_];
	    if (i_58_ < i && i_58_ > i_56_) {
		i_55_ = i_57_;
		i_56_ = i_58_;
	    }
	}
	...
	int i_59_ = arg2 - arg0;
	int i_60_ = i < 0 ? -i : i;
	int i_61_ = i_60_ * (arg4 - arg0);
	int i_62_ = i_61_ / i_59_;
	return i < 0 ? arg1 - i_62_ : arg1 + i_62_;
    }
}
